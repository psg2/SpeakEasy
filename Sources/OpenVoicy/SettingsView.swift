...
struct SettingsView: View {
    ...
    @State private var selectedLanguage: WhisperLanguage = WhisperLanguage.autoDetect
            ...
            self.settingsCard("Transcription") {
                    ...
                    description: "Select the language for transcription")
                {
                    Picker("Language", selection: self.$selectedLanguage) {
                        Text("\(WhisperLanguage.autoDetect.flag) \(WhisperLanguage.autoDetect.name)")
                            .tag(WhisperLanguage.autoDetect)

                        Divider()

                        ForEach(WhisperLanguage.allLanguages) { language in
